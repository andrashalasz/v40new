        ...
        <div class="relative z-10 w-full flex flex-col lg:flex-row items-end justify-end lg:justify-between">
            <div class="w-full lg:w-auto">
                <h1
                    ...
                    {{ t('rolunk.hero.title', 'Rólunk') }}
                </h1>
                <p
                    class="dm-sans text-[#F4F4F0] text-[18px] lg:max-w-[490px] leading-[1.3] drop-shadow-md">
                    {{ t('rolunk.hero.lead', 'Ismerd meg orvosainkat és rendelőnket, hogy tudd, milyen környezet és szakmai háttér vár nálunk.') }}
                </p>
            </div>

            <div class="w-full lg:w-auto flex flex-col items-start mt-4 lg:mt-0 lg:items-end">
